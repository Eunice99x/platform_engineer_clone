...
type Token struct {
	...
	Revoked   int8      `boil:"revoked" json:"revoked" toml:"revoked" yaml:"revoked"`
	Expired   int8      `boil:"expired" json:"expired" toml:"expired" yaml:"expired"`
...
var TokenWhere = struct {
	...
	Revoked   whereHelperint8
	Expired   whereHelperint8
	...
	Revoked:   whereHelperint8{field: "`token`.`revoked`"},
	Expired:   whereHelperint8{field: "`token`.`expired`"},
